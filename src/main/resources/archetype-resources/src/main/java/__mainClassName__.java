...
import ${package}.util.log.LogConfigurator;
...
public class ${mainClassName} extends Application {
	 ...
	 * シングルトン.
	 */
	private static ${mainClassName} singleton;
	...
	public static ${mainClassName} getSingleton() {
		if (singleton == null) {
	 ...
	 * @param inst
	 */
	private static void setSingleton(${mainClassName} inst) {
		if (singleton != null) {
